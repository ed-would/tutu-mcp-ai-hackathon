...
[![Live demo](https://img.shields.io/badge/demo-Vercel-0D0B68?style=flat-square)](https://tutu-mcp-ai-hackathon.vercel.app)
[![Guide](https://img.shields.io/badge/guide-онбординг-7D71FF?style=flat-square)](https://tutu-mcp-ai-hackathon.vercel.app/guide)
[![Discover](https://img.shields.io/badge/discover-свайпы-EFBA6F?style=flat-square)](https://tutu-mcp-ai-hackathon.vercel.app/discover)
[![Stack](https://img.shields.io/badge/stack-Vite%208%20·%20React%2019%20·%20TS%207-5149D8?style=flat-square)](#-технологический-стек)
[![MCP](https://img.shields.io/badge/Tutu%20MCP-live%20v0.38-c8e4d0?style=flat-square)](https://mcp.tutu.ru/mcp)

<p align="center">
  <img src="apps/app/public/logo.png" alt="Туту Куда?" width="120" />
</p>
...
<p align="center">
  <img src="apps/app/public/pic-0.png" alt="Открытка направления" width="280" />
  <img src="apps/app/public/pic-1.png" alt="Карточка поездки" width="280" />
  <img src="apps/app/public/pic-2.png" alt="Свайп и нить маршрута" width="280" />
</p>
...
**Питч-демо (до 10 минут):** `/guide` → `/discover` с живым промптом → свайпы → пакеты → переход на tutu.ru.

Сдача: публичный URL, этот репозиторий, freeze **21:00 МСК, 19 августа 2026**.
