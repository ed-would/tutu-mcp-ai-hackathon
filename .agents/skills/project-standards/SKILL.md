...
- Read application code, MCP integration, and Codex automation layout.
...
- Documentation: `AGENTS.md`, `docs/agents/`, `docs/plans/standards-cursor/` (universal Codex standards — do not overwrite unless asked)
...
- Do not overwrite `docs/plans/standards-cursor/` (universal Codex standards) unless the user explicitly asks.
