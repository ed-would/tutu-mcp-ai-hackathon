...
argument-hint: 'feature description, task text, or GitHub issue URL'
---
...
4. Choose a semantic prefix under `docs/plans/` for Travel Tinder work (`product-` or `travel-tinder-exec-`), or for cross-cutting concerns (`architecture-`, `audit-`, `docs-`, `improvement-`, `optimization-`, `release-`) plus a short kebab-case slug. Do not use numeric prefixes.
...
6. Present the plan path in chat. Do not add a separate spec gate; proceed to implementation when the plan is accepted.
