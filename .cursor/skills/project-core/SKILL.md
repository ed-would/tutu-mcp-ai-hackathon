...
- Apply for MCP client configuration (`.cursor/mcp.json`, Claude/Cursor connector setup) when it affects how agents call Tutu.
...
| Cursor automation| `.cursor/rules/`, `.cursor/skills/`, `.cursor/agents/`, `.cursor/commands/` |
